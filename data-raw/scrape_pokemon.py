...
Usage:
    ...
    data = scrape_pokedex("pokedex.csv")       # also saves to a csv file
"""
...
def scrape_pokemon(output_file=None):
    """
...
if __name__ == "__main__":
    data = scrape_pokemon("data-raw/pokemon.csv")
    print(f"Scraped {len(data)} pokemon")
    print(data[0])
